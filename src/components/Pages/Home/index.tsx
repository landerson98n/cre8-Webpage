    ...
    const informations = [
        {
            ...
            title: '+275 alunos',
            subtitle: '<h5>Mais de 275 alunos fazem parte da nossa história.</h5>'
        },
        {
            src: isMobile ? 'https://ik.imagekit.io/6zjortsiwu/tr:w-200/globo.webp' : 'https://ik.imagekit.io/6zjortsiwu/globo.webp',
            title: 'Mundo',
            subtitle: '<div><h5>Alunos em 8 países.</h5></div>'
        },
        {
            src: isMobile ? 'https://ik.imagekit.io/6zjortsiwu/tr:w-200/distintivo.webp' : 'https://ik.imagekit.io/6zjortsiwu/distintivo.webp',
            title: 'Brasil',
            subtitle: '<h5>Alunos em 18 estados do Brasil.</h5>'
        }
    ]
